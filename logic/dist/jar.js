...
/** Create a new group */
export async function createGroup(cfg, privKey, name, targetAmountEth, durationDays) {
    const jar = getJarSigner(cfg, privKey);
    const tx = await jar.createGroup(name, parseEther(targetAmountEth), durationDays);
    const rcpt = await tx.wait();
    // Extract group ID from events
    const event = rcpt.logs.find((log) => {
        try {
...
export async function joinGroup(cfg, privKey, groupId, bondAmountEth) {
    const jar = getJarSigner(cfg, privKey);
...
export async function leaveGroup(cfg, privKey, groupId) {
    const jar = getJarSigner(cfg, privKey);
...
export async function depositBondToGroup(cfg, privKey, groupId, amountEth) {
    const jar = getJarSigner(cfg, privKey);
...
export async function withdrawBondFromGroup(cfg, privKey, groupId, amountEth) {
    const jar = getJarSigner(cfg, privKey);
...
export async function applyPenaltyToGroup(cfg, privKey, groupId, user, amountEth) {
    const jar = getJarSigner(cfg, privKey);
...
export async function withdrawGroupPot(cfg, privKey, groupId, to, amountEth) {
    const jar = getJarSigner(cfg, privKey);
...
export async function distributeGroupPot(cfg, privKey, groupId) {
    const jar = getJarSigner(cfg, privKey);
...
export async function deactivateGroup(cfg, privKey, groupId) {
    const jar = getJarSigner(cfg, privKey);
...
export async function getGroup(cfg, groupId) {
    const jar = getJarReader(cfg);
...
export async function getGroupMember(cfg, groupId, member) {
    const jar = getJarReader(cfg);
