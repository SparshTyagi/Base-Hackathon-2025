...
describe('ConsensusService', () => {
    ...
    describe('Vote Processing', () => {
        it('should calculate vote results correctly', async () => {
            ...
            // Create a vote
            const vote = await groupService.createVote(group.id, 'pot_distribution', { recipient: '0x3333333333333333333333333333333333333333', amount: '0.1' }, groupRequest.creatorAddress, 24);
    ...
    describe('Group Votes', () => {
        it('should get group votes', async () => {
            ...
            await groupService.createVote(group.id, 'pot_distribution', { recipient: '0x3333333333333333333333333333333333333333', amount: '0.1' }, groupRequest.creatorAddress, 24);
            await groupService.createVote(group.id, 'rule_change', { action: 'add', ruleData: { name: 'New Rule', penaltyAmount: '0.01' } }, groupRequest.creatorAddress, 48);
